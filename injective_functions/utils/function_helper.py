...
class InjectiveFunctionMapper:
    ...
    FUNCTION_MAP: Dict[str, Tuple[str, str]] = {
        ...
        "get_mid_price_and_tob_derivatives_market": ("exchange", "get_mid_price_and_tob_derivatives_market"),
        "get_mid_price_and_tob_spot_market": ("exchange", "get_mid_price_and_tob_spot_market"),
        ...
        "trader_derivative_orders_by_hash" : ("exchange", "trader_derivative_orders_by_hash"),
    ...
    def get_functions_for_client(cls, client_type: str) -> list:
        ...
        return [
            func_name for func_name, (client, _) in cls.FUNCTION_MAP.items()
